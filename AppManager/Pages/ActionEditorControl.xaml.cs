...
namespace AppManager.Pages
{
    public partial class ActionEditorControl : UserControl
    {
        ...
        {
            if (ActionTypeComboBox.SelectedItem is AppActionEnum actionType)
            {
        ...
        private void AddConditionButton_Click(object sender, RoutedEventArgs e)
        {
            if (ConditionTypeComboBox.SelectedItem is ConditionTypeEnum conditionType)
            {
                ...
                // Show condition configuration dialog (you might want to create a separate dialog for this)
        ...
        private async void TestActionButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                var action = CreateActionModel();
    ...
    // Simple condition configuration dialog (you might want to make this more sophisticated)
